...
describe('CategorySequelizeRepository Integration Test', () => {
  ...
  it.skip('should finds a entity by id', async () => {
  ...
  it.skip('should throw error on delete when a entity not found', async () => {
  ...
  describe('search method tests', () => {
    ...
    it.skip('should apply paginate and sort', async () => {
